...
const EmailsPage: NextPage = () => {
    ...
    const { data } = useSWR('mail-list', fetcher, {fallbackData: [], refreshInterval: 5000 });
        ...
        <div>
            ...
            <form onSubmit={onSubmit}>
                <div className="mb-4">
                    <textarea
                        id="emails"
                        className="bg-default border rounded w-full py-2 px-3 text-black dark:text-white first-letter:text-white leading-tight focus:outline-none focus:shadow-outline"
